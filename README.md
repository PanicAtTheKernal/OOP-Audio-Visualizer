...
The thing we are most proud is how well each our visuals works with each other. The interactivity added to our project by our multi-mode controls allows the user to create a multi-visual to their liking. Each of our visuals syncs to the song but visualizes it in different ways. Combined together creates a stunning visual. The use of polymorphism with the MyVisual class allowed our visuals to work together without any sort of interference. It also made implementation of each visual into the main project a seamless experience. Also all of our co-ordination and team work to work together allowed to finish this project in a timely manner helped out a lot.   
